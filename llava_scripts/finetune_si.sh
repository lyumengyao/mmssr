# following https://github.com/LLaVA-VL/LLaVA-NeXT/blob/main/scripts/train/finetune_si.sh 
# for all results reported, we adjusted model_max_length=12000, per_device_train_batch_size=2 with 64 gpus to perform fair comparison & save the computational costs

DATA_FILE="/path/to/mmssr_selection/subset.json"
