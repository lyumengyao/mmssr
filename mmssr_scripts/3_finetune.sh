...
# To train your own mmSSR for data sampling,
# first curate a small amount of data from human experts, teacher models or other alternatives
DATA_FILE="/path/to/your/score/file.json"
IMAGE_FOLDER="/path/to/data/images"

# then finetune a mmSSR with LLaVA-OV or other sota archs
